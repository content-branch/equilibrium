  ...
  return (
    <Suspense fallback={<Loading cover="page"/>}>
      <Switch>
        ...
        <Route path={`${AUTH_PREFIX_PATH}/404`} component={lazy(() => import(`./errors/error-page-1`))} />
        <Route path={`${AUTH_PREFIX_PATH}/server-error`} component={lazy(() => import(`./errors/error-page-2`))} />
